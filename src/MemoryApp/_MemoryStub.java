...
public class _MemoryStub extends org.omg.CORBA.portable.ObjectImpl implements MemoryApp.Memory
{
  ...
  public void deleteResource (String resource)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("deleteResource", true);
                $out.write_string (resource);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
  ...
  public void shareMemory (String memory, String username)
  {
            ...
            try {
                ...
                shareMemory (memory, username        );
            } finally {
                _releaseReply ($in);
            }
  } // shareMemory

  public void transferPoints (int points, String username)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("transferPoints", true);
                ...
                transferPoints (points, username        );
            } finally {
                _releaseReply ($in);
            }
  } // transferPoints
